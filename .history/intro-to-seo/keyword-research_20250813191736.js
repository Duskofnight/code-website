...
function checkAnswer(quizId, correctAnswer, feedbackId) {
  ...
  if (selectedAnswer === correctAnswer) {
    ...
    if (singleBtn) {
      ...
      singleBtn.onclick = function() { resetQuiz(quizId, feedbackId); };
...
function checkRadioAnswer(quizName, correctAnswer, feedbackId) {
  ...
  if (selectedRadio.value === correctAnswer) {
    ...
    if (singleBtn) {
      singleBtn.textContent = 'Try Again';
      singleBtn.onclick = function() { resetRadioQuiz(quizName, feedbackId); };
      singleBtn.style.background = '#f39c12';
    }
  }
}
...
function resetQuiz(quizId, feedbackId) {
  ...
  if (singleBtn) {
    ...
    singleBtn.onclick = function() { checkAnswer(quizId, 'a', feedbackId); }; // You'll need to pass the correct answer here
...
function resetRadioQuiz(quizName, feedbackId) {
  ...
  if (singleBtn) {
    singleBtn.textContent = 'Submit Answer';
    singleBtn.onclick = function() { checkRadioAnswer(quizName, 'title', feedbackId); }; // You'll need to pass the correct answer here
    singleBtn.style.background = '';
  }
