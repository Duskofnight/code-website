// SEO Course Progress Tracker with Supabase Integration

// Initialize Supabase client (make sure to include Supabase script in your HTML)
...
class SEOProgressTracker {
    ...
    isLessonUnlocked(lessonId) {
        // ONLY the very first lesson is unlocked by default
        if (lessonId === 'seo-introduction') {
            return true;
        }
        ...
        if (!previousLessonId) {
            return false; // If no previous lesson found, keep it locked
        }
    ...
    getPreviousLessonId(currentLessonId) {
        // Define the complete lesson order across all sections
        const allLessons = [
            'seo-introduction',
            'keyword-research', 
            'seo-quiz',
        ...
        return null; // No previous lesson (this is the first lesson)
    }
    ...
    updateLessonStates() {
        ...
        lessonElements.forEach(element => {
            ...
            const existingIcons = element.querySelectorAll('.completion-icon, .lock-icon');
        ...
        console.log('Updated lesson states. User progress:', this.userProgress);
    }
