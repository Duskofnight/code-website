const slides = ['#one', '#two', '#three', '#four', '#five', '#six', '#seven', '#eight', '#nine', '#ten', '#eleven', '#end'];
...
function submitAnswer() {
  ...
  if (isCorrect) {
    feedback.className = 'feedback correct';
    feedback.innerHTML = '🎉 Correct! On-Page Optimization Focuses on Optimizing Content and HTML Elements!';
  } else {
    feedback.className = 'feedback incorrect';
