...
function resetQuiz(quizId, feedbackId) {
  ...
  submitBtn.onclick = function() { checkAnswer('quiz1', 'd', 'feedback1'); };
...
const correctAnswer = ['Impressions'];
...
function submitAnswer() {
  ...
  if (isCorrect) {
    feedback.className = 'feedback correct';
    feedback.innerHTML = '🎉 Nice! Google Search Console Tells You Your Search Impressions on Your Website!';
  } else {
    feedback.className = 'feedback incorrect';
